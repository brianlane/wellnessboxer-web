  ...
  return (
    <>
      ...
      >
        ...
        <p>
          When you reserve a bundle, subscribe, or join the waitlist we collect:
          name, email address, shipping address (at fulfilment), payment
          authorisation token (held by Stripe / Shopify Payments, never by
          Wellness Boxer), and basic device/analytics data via Vercel Web
          Analytics.
        </p>
        ...
        <ul>
          ...
          <li>
            To send transactional and product-update emails you opted into
          </li>
        ...
        <p>
          ...
          business: Shopify (commerce + checkout), Vercel (hosting + analytics),
          Stripe / Shopify Payments (payment processing), Klaviyo or equivalent
          (transactional + marketing email), and our shipping carriers.
        </p>
        ...
        <p>
          ...
          <a href="mailto:privacy@wellnessboxer.com">
            privacy@wellnessboxer.com
          </a>
          .
        </p>
